  ...
  return (
    <Card className="group relative h-full flex flex-col bg-surface border-border hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 overflow-hidden">
      ...
      {resource.is_featured && (
        <div className="absolute top-0 left-0 text-xs font-bold px-3 py-1.5 rounded-br-lg z-10 shadow-lg" style={{ background: 'linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%)' }}>
          <span className="flex items-center gap-1" style={{ color: '#1e2926' }}>
            <svg className="w-3 h-3" style={{ fill: '#1e2926' }} viewBox="0 0 20 20">
